...
<p align="center">
  <!-- DRAG AND DROP LOCKSCREEN/LAUNCHER IMAGES HERE -->
...
<p align="center">
  <!-- DRAG AND DROP WAYBAR FULL WIDTH SCREENSHOT HERE -->
  <img width="100%" alt="Waybar screenshot" src="DROP_WAYBAR_IMAGE_HERE" />
</p>
